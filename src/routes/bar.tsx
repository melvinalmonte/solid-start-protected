...
const Bar: Component = () => {
  return (
    <div class="flex items-center justify-start bg-white py-4 px-4">
      <div class="mx-auto w-full max-w-lg">
        <h1 class="text-4xl font-medium">Don&apos;t contact us</h1>
        <p class="mt-3">Don&apos;t e-mail us at help@domain.com or message us here:</p>
        ...
        <form class="mt-10">
          ...
          <button type="button" class="mt-5 rounded-md bg-black px-10 py-2 text-white">
            Really, don&apos;t
          </button>
        </form>
      </div>
